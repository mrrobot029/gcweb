<?php
  ...
  // Use openssl_decrypt() function to decrypt the data 
    ...
    if($id == $decryptedkey){
        ...
        $authenticated = true;
        if($status[0] == '0'){
            $updateStatus = "UPDATE tbl_gcat SET gc_status = '1', gc_confirmdate = '$datetimenow' WHERE gc_idnumber = '$id'";
            if(mysqli_query($conn, $updateStatus)){
                            ...
                            $mail->Body .= "<b><i>As of March 11, 2020, Gordon College has postponed the schedules for submission of requirements until further notice. Please stand by and check our <a href='https://www.facebook.com/GordonCollegeOfficial/'>facebook page<a> regularly for updates on this matter.</i></b><br><br>";
